...
// Aleth's p2p headers include Boost.Asio and can be reached from nested
// namespaces. Include Asio globally first so its guards are set cleanly.
...
static const signed int DEFAULT_AUTOCHECKPOINT = 10;

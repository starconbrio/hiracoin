...
const char * const BITCOIN_CONF_FILENAME = "hiracoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Hiracoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Hiracoin";
#else
    // Unix
    return pathRet / ".hiracoin";
#endif
#endif
}

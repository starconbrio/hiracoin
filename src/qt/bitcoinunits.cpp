...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("HIR");
    case mBTC: return QString("mHIR");
    case uBTC: return QString::fromUtf8("uHIR (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Hiracoin");
    case mBTC: return QString("Milli-Hiracoin (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Hiracoin (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
